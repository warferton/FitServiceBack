...
class NodeTransport {
    constructor() {
        this.yields = [];
        this.signal = nats_base_client_1.deferred();
        this.closedNotification = nats_base_client_1.deferred();
    ...
    connect(hp, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                nats_base_client_1.checkOptions(info, options);
    ...
    dial(hp) {
        const d = nats_base_client_1.deferred();
        let dialError;
        const socket = net_1.createConnection(hp.port, hp.hostname, () => {
            d.resolve(socket);
    ...
    peekInfo() {
        ...
        this.socket.on("data", (frame) => {
            ...
            const pm = nats_base_client_1.extractProtocolMessage(t);
            if (pm) {
                try {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof this.options.tls === "object") {
                try {
                    ...
                    tlsOpts = util_1.extend(tlsOpts, this.options.tls, certOpts);
                }
                catch (err) {
            ...
            const d = nats_base_client_1.deferred();
            try {
                const tlsSocket = tls_1.connect(tlsOpts, () => {
        ...
        return __asyncGenerator(this, arguments, function* iterate_1() {
            ...
            while (true) {
                ...
                for (let i = 0; i < yields.length; i++) {
                    if (debug) {
                        console.info(`> ${nats_base_client_1.render(yields[i])}`);
                    }
    ...
    send(frame) {
        ...
        if (this.options.debug) {
            console.info(`< ${nats_base_client_1.render(frame)}`);
        }
        const d = nats_base_client_1.deferred();
